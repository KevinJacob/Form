...
- (void)_initialize {
    ...
    UIBarButtonItem *space1         = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace
                                                                                    target:nil
                                                                                    action:nil];
    UILabel         *labelView      = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 150, toolBar.frame.size.height)];
    labelView.text                  = [NSString stringWithFormat:@"Please sign below"];
    labelView.textColor             = [UIColor whiteColor];
    UIBarButtonItem *labelItem      = [[UIBarButtonItem alloc] initWithCustomView:labelView];
    UIBarButtonItem *space2         = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace
                                                                                    target:nil
                                                                                    action:nil];
    
    NSArray *items = @[cancelButton, space1, labelItem, space2, self.doneButton];
...
- (void)_setupDefaultValues {
    self.foregroundLineColor = [UIColor colorWithRed:0.204 green:0.596 blue:0.859 alpha:1.000];
...
{
    [_delegate signatureViewDidEnd:NO];
}
...
- (void)done:(id)sender
{
    [_delegate signatureViewDidEnd:YES];
}
